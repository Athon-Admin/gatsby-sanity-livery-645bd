...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/603645bd9cfb300016205bb6
...
To start editing your site, you can use the Sanity interface at https://gatsby-sanity-livery-645bd.sanity.studio/.
...
Generated at `2021-02-24T12:27:11.715Z` by Stackbit version `0.3.50`.